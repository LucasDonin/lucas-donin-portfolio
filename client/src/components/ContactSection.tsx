    ...
    <>
      ...
      >
        <div className="absolute inset-0 pointer-events-none" style={{
          background: 'radial-gradient(circle at 30% 60%, oklch(0.78 0.14 88 / 0.06) 0%, transparent 55%)',
        }} />
        ...
        <div className="relative z-10 container text-center py-20">
          ...
          <p className="text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-12 md:mb-16 gsap-fade-up" style={{ color: '#777' }}>
            ...
            style={{
              ...
              boxShadow: '0 6px 32px oklch(0.78 0.14 88 / 0.18), inset 0 1px 0 rgba(255,255,255,0.08)',
